...
- - (name) (server): prints damage modifier of character name from server. Possible servers: "Yurian", "Seren", "Mystel", "Shakan". If player is in the same server as you, server argument is not needed
